...
if __name__ == '__main__':
  ...
  for filename in args.files:
    ...
    perc.append(('I$ DMA stall', data['ic_dma']))
    perc.append(('D$ DMA stall', data['dc_dma']))
    perc.append(('DMA stall ratio', (data['ic_dma']+data['dc_dma'])/(data['wdma_wait']+data['rdma_wait'])))
